...
(function (factory) {
    ...
    $.fn.fileinput1 = function (option) {
        ...
        this.each(function () {
            var self = $(this), data = self.data('fileinput'), options = typeof option === 'object' && option,
                lang = options.language || self.data('language') || 'en', config = $.fn.fileinput1.defaults;
    ...
    $.extend($.fn.fileinput1.defaults, $.fn.fileinputLocales.en);

    $.fn.fileinput1.Constructor = FileInput;
