...
<script>
   $('#contact').validate({
          ...
          submitHandler: function(form) {
              ...
              $.ajax({
                  url: "<?php echo e(url('/')); ?>/ajax/contact_us",
                  method: 'post',
...
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hngeno\Projects\resource-center\resources\views/contact.blade.php ENDPATH**/ ?>