    ...
    <div class="modal-dialog modal-lg" style="width: 750px">
        <div class="modal-content">
            <div class="modal-body">
                ...
                <form class="form-group" method="post" action="<?php echo e(url('/')); ?>/edit_company" id="edit-company" enctype="multipart/form-data">
...
<script>
    ...
    $input.fileinput1({
        ...
        uploadUrl: "<?php echo e(url('/')); ?>/upload", // server upload action
...
<script>
    $('[class^=a][type="file"]').ezdz({
        text:"<img src='<?php echo e(url('/')); ?>/public/images/upload_box.png'/>"
    }  );
</script>
...
<script>
    $("#edit_company").click(function(){
        ...
        $.ajax({
            url: "<?php echo e(url('/')); ?>/ajax/edit_company",
            type: 'post',
            data: formData,
            contentType: false,
            processData: false,
...
<script>
    $("#edit-profile").validate({
        ...
        submitHandler:function(form){
            ...
            $.ajax({
                url:"<?php echo e(url('/')); ?>/ajax/edit_profile",
                method:'post',
...
<script>
    $("#registration-form").validate({
        ...
        submitHandler:function(form){
            ...
            $.ajax({
                url:"<?php echo e(url('/')); ?>/ajax/register",
                method:'post',
...
<script>
    $("#registration-form-download").validate({
        ...
        submitHandler:function(form){
            ...
            $.ajax({
                url:"<?php echo e(url('/')); ?>/ajax/register_download",
                method:'post',
...
<script>
    $("#login-download-form").validate({
        ...
        submitHandler:function(form){
            ...
            $.ajax({
                url:"<?php echo e(url('/')); ?>/ajax/login_download",
                method:'post',
...
<script>
    $("#forget-password").validate({
        ...
        submitHandler:function(form){
            ...
            $.ajax({
                url:"<?php echo e(url('/')); ?>/ajax/forgot_password",
                method:'post',
...
<script>
    function editprofile()
    {
        ...
        $.ajax({
            url:"<?php echo e(url('/')); ?>/ajax/edit_profile_modal",
            method:'post',
            data:'',
            success:function(data){
                $(".ep").html(data);
...
<script>
    ...
    {
        $.post("<?php echo e(url('/')); ?>/ajax/edit_company_modal",function(data){
            console.log(data);
...
<script>
    $("#update-password").validate({
        ...
        submitHandler: function(form) {
            ...
            $("#upass").html('Loading ...');
            $.ajax({
                url: "<?php echo e(url('/')); ?>/ajax/update_password",
                method: "post",
                cache: "false",
...
<script>
    $("#update-password2").validate({
        ...
        submitHandler: function(form) {
            ...
            $("#upass").html('Loading ...');
            $.ajax({
                url: "<?php echo e(url('/')); ?>/ajax/update_password2",
                method: "post",
                cache: "false",
...
<script>
    $('#upload-resource').validate({
        ...
        submitHandler:function(form){
            ...
            $("#upload").html('Loading ....');
            $.ajax({
                url:"<?php echo e(url('/')); ?>/upload_resource",
                type:"post",
                cache: false,
                data:formData,
                error:function()
...
<script>
    $("#verify-code").validate({
        ...
        submitHandler: function(form) {
            ...
            $.ajax({
                url: "<?php echo e(url('/')); ?>/ajax/user_verify_code",
                method: "post",
                cache: "false",
...
<script>
    $("#set-password").validate({
        ...
        submitHandler: function(form) {
            ...
            $.ajax({
                url: "<?php echo e(url('/')); ?>/ajax/user_set_password",
                method: "post",
                cache: "false",
...
<script>
    ...
    {
        $.ajax({
            url:"<?php echo e(url('/')); ?>/ajax/logout",
            method:'post',
            data:'',
            success:function(data){
                $(".dd").html(data);
...
<script>
    function resourceDetail(id){
        $.ajax({
            ...
            url:"<?php echo e(url('/')); ?>/ajax/resource_detail",
            method:"post",
            data:{id:id},
            success:function(data){
...
<script>
    function resourceDownload(id){
        ...
        $.ajax({
            url:"<?php echo e(url('/')); ?>/ajax/download_resource",
            method:"post",
            data:{id:id},
            success:function(data){
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        $('.infinite-scroll').jscroll({
            autoTrigger: true,
            loadingHtml: '<img class="center-block" style="margin-bottom:20px" src="<?php echo e(url('/')); ?>/public/images/rolling.gif" alt="Loading..." />',
            padding: 0,
...
<script>
    $("#contact-form").validate({
        ...
        submitHandler:function(form){
            ...
            $("#submit").html('Sending ......');
            $.ajax({
                url:"<?php echo e(url('/')); ?>/ajax/contact",
                method:'post',
    ...
    $("#update-schedule").validate({
        ...
        submitHandler:function(form){
            ...
            $.ajax({
                url:"<?php echo e(url('/')); ?>/ajax/edit_schedule",
                method:'post',
    ...
    function request_demo(id){
        $.ajax({
            url:"<?php echo e(url('/')); ?>/ajax/request_demo/"+id,
            method:"post",
            success:function(data){
                var obj = jQuery.parseJSON( data );
    ...
    $("#request-quote").validate({
        ...
        submitHandler:function(form){
            ...
            $.ajax({
                url:"<?php echo e(url('/')); ?>/ajax/request_quote",
                method:'post',
                data:formData,
                success: function(data) {
    ...
    $("#upload-product").validate({
        ...
        submitHandler:function(form){
            ...
            $.ajax({
                url:"<?php echo e(url('/')); ?>/ajax/add_product",
                method:'post',
                data:formData,
                success: function(data) {
                    $("#add_product_btn").attr('disabled',false);
    ...
    function delete_product(id)
    {
        bootbox.confirm("Are you sure you want to delete this Product?", function (result) {
            if (result == true) {
                $.get("<?php echo e(url('/')); ?>/ajax/delete_product/"+id, function (result) {
...
<?php /**PATH C:\Users\hngeno\Projects\resource-center\resources\views/scripts.blade.php ENDPATH**/ ?>