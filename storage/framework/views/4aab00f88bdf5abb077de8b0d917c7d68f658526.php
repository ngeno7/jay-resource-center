                            ...
                            <ul class="dropdown-menu multi-column columns-3 dd-left m-top-minus-5 m-t-1">
                                <div class="row">
                                    <div class="col-sm-3" style="border-right: 1px solid #efefef;">
                                        <?php $__currentLoopData = $column4; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <ul class="multi-column-dropdown">
                                                <li class="hoverable">
                                                    <a href="/search?&content_category=<?php echo e($category->industryid); ?>"><?php echo e($category->industryname); ?></a>
                                                </li>
                                            </ul>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                    <div class="col-sm-3" style="border-right: 1px solid #efefef;">
                                        <?php $__currentLoopData = $column1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <ul class="multi-column-dropdown">
                                                <li class="hoverable">
                                                    <a href="/search?&content_category=<?php echo e($category->industryid); ?>"><?php echo e($category->industryname); ?></a>
                                                </li>
                                    ...
                                    <div class="col-sm-3" style="border-right: 1px solid #efefef;">
                                        <?php $__currentLoopData = $column2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <ul class="multi-column-dropdown">
                                                <li class="hoverable">
                                                    <a href="/search?&content_category=<?php echo e($category->industryid); ?>"><?php echo e($category->industryname); ?></a>
                                                </li>
                                    ...
                                    <div class="col-sm-3">
                                        <?php $__currentLoopData = $column3; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <ul class="multi-column-dropdown">
                                                <li class="hoverable">
                                                    <a href="/search?&content_category=<?php echo e($category->industryid); ?>"><?php echo e($category->industryname); ?></a>
                                                </li>
                                    ...
                                    <div class="dropdown-menu dropDown-menu-m">
                                        <?php if($user_status=='approved'): ?>
                                            <a class="dropdown-item waves-effect waves-light" style="color: #ca311b"
                                               href="<?php echo url('/').'/company-detail/'.preg_replace('/[^A-Za-z0-9\-]/', '',strtolower(str_replace(' ','-',$companyName))).'/'.$user_id ?>"><?php echo e($username); ?></a>
                                            <a class="dropdown-item waves-effect waves-light"
                                               href="<?php echo e(url('/')); ?>/analytics">Profile Analytics</a>
                                            <a class="dropdown-item waves-effect waves-light" data-toggle="modal"
...
<?php /**PATH C:\Users\hngeno\Projects\resource-center\resources\views/header.blade.php ENDPATH**/ ?>