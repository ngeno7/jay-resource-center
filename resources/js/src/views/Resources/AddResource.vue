        ...
        <form ref="editForm" @submit.prevent="submit($event)">
                ...
                <vs-col vs-lg="9" vs-md="9" vs-sm="12" vs-xs="12">
                    <vs-col vs-lg="6" vs-md="6" vs-xs="12" vs-sm="12">
                        <vx-input-group>
                            ...
                            <vs-input v-validate="'required'" v-model="resource_topic" placeholder="Topic" label="Topic" name="topic" />
                            <span v-show="errors.has('topic')">{{ errors.first('topic') }}</span>
                        </vx-input-group>
                    </vs-col>
                    <vs-col class="pl-0" vs-lg="6" vs-md="6" vs-xs="12" vs-sm="12">
                        <vx-input-group>
                            <vs-input v-validate="'required'" v-model="author_name" placeholder="Author Name" label="Author Name" name="author" />
                    ...
                    <vs-col class="pl-0" vs-lg="6" vs-md="6" vs-xs="12" vs-sm="12">
                        <vx-input-group class="">
                            <vx-select @input="changeResource" name="type_of_resource" data-vv-as="Type Of Resource" v-model="type_of_resource" placeholder="Select Resource Type" label="Type Of Resource">
            ...
            <vs-row class="mt-base">
                <vs-col>
                    <vs-col class="pl-0" vs-lg="4" vs-md="4" vs-xs="12" vs-sm="12">
                        <vx-input-group>
                            <template>
                                <vs-input :label="type_of_resource == 6?'Video Link (Youtube/Vimeo/Websites)':'E-Book Link'" v-if="type_of_resource == 6 || type_of_resource == 7" v-model="link" />
                            </template>
                        </vx-input-group>
                    </vs-col>
                    <vs-col class="pl-0" vs-lg="4" vs-md="4" vs-xs="12" vs-sm="12">
                        <vx-input-group class="">
                            <vx-select @blur="blurMe" placeholder="Select Content Type" name="content_type" :autocomplete="true" multiple v-validate="'required'" v-model="content_type" data-vv-as="Content Type" label="Content Type">
                    ...
                    <vs-col class="pl-0" vs-lg="4" vs-md="4" vs-xs="12" vs-sm="12">
                        <vx-input-group class="">
                            <vx-select v-validate="'required'" multiple label="Content Category" placeholder="Select Content Category" name="content_category" v-model="contentCategory" data-vv-as="Content Category">
                ...
                <vs-col class="mt-base">
                    <quill-editor v-validate="'required'" name="description" style="height: 400px" v-model="description"></quill-editor>
                    ...
                    <template>
                        ...
                        <vs-col v-show="isShownUtm" v-if="view == 'utm'">
                            <vx-input-group class="mt-base">
                                <vs-input type="url" v-validate="'required'" v-model="resource_path" placeholder="https://www.example.com" label="" name="resource" />
            ...
            <vs-row class="mt-base">
                <vs-col class="mt-base" vs-lg="12" vs-md="12" vs-sm="12" vs-xs="12">
                    <vs-button button="submit" type="gradient" class="float-right">Create Resource</vs-button>
                </vs-col>
            </vs-row>
            <br>
        </form>
    ...
    methods: {
        ...
        submit(e) {
                ...
                if (result) {
                    ...
                    if (this.view == 'file' && this.type_of_resource != 6 && this.type_of_resource != 7) {
                    ...
                    fd.append('type_of_resource',this.type_of_resource);
