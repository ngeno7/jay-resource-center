...
<div class="relative">
	<div class="vx-navbar-wrapper">
		<vs-navbar class="vx-navbar navbar-custom" :color="navbarColor" :class="classObj">
			...
			<vs-spacer></vs-spacer>
            <div id="page-loader" class="vs-con-loading__container"></div>
			<!-- USER META -->
			<div class="the-navbar__user-meta flex items-center">
				...
				<vs-dropdown vs-custom-content vs-trigger-click class="cursor-pointer">
					<div class="con-img ml-3"><vs-avatar icon-pack="feather" icon="icon-user" size="40px" class="rounded-full shadow-md cursor-pointer block"></vs-avatar></div>
					<vs-dropdown-menu class="vx-navbar-dropdown">
						<ul style="min-width: 9rem">
                            <li class="flex py-2 px-4 cursor-pointer hover:bg-primary hover:text-white" @click="letsLogout()"><feather-icon icon="LogOutIcon" svgClasses="w-4 h-4"></feather-icon> <span class="ml-2">Logout</span></li>
						</ul>
					</vs-dropdown-menu>
				</vs-dropdown>
			</div>
