                ...
                <form  class="form-group" enctype="multipart/form-data"   id="upload-resource" method="post" action="">
                    ...
                    <div class="col-md-8 col-lg-8"  >
                        ...
                        <select class="mdb-select" id="show" name="typeofresource">
                            @foreach($type_of_resource as $type)
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <select   class="form-control" name="m_o_t">
                                        <option value="" label="Open Time" @if(empty($m_o_t)) {{"Selected"}} @endif></option>
                                        @include('schedule_list',array('value'=>$m_o_t))
                                    </select>
                                </div>
                                <div class="col-md-4">
                                    <select  class="form-control"  name="m_c_t">
                                        <option value=""  label="Close Time" @if(empty($m_c_t)) {{"Selected"}} @endif></option>
                                        @include('schedule_list',array('value'=>$m_c_t))
                                    </select>
                                </div><br/><br/>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <select   class="form-control" name="tu_o_t">
                                        <option value=""  label="Open Time" @if(empty($tu_o_t)) {{"Selected"}} @endif></option>
                                        @include('schedule_list',array('value'=>$tu_o_t))
                                    </select>
                                </div>
                                <div class="col-md-4">
                                    <select  class="form-control"  name="tu_c_t">
                                        <option value="" label="Close Time"> @if(empty($tu_c_t)) {{"Selected"}} @endif</option>
                                        @include('schedule_list',array('value'=>$tu_c_t))
                                    </select>
                                </div><br/><br/>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <select   class="form-control" name="w_o_t">
                                        <option value=""  label="Open Time" @if(empty($w_o_t)) {{"Selected"}} @endif></option>
                                        @include('schedule_list',array('value'=>$w_o_t))
                                    </select>
                                </div>
                                <div class="col-md-4">
                                    <select  class="form-control"  name="w_c_t">
                                        <option value=""  label="Close Time" @if(empty($w_c_t)) {{"Selected"}} @endif></option>
                                        @include('schedule_list',array('value'=>$w_c_t))
                                    </select>
                                </div><br/><br/>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <select   class="form-control" name="t_o_t">
                                        <option value="" @if(empty($t_o_t)) {{"Selected"}} @endif label="Open Time"></option>
                                        @include('schedule_list',array('value'=>$t_o_t))
                                    </select>
                                </div>
                                <div class="col-md-4">
                                    <select  class="form-control"  name="t_c_t">
                                        <option value="" @if(empty($t_c_t)) {{"Selected"}} @endif label="Close Time"></option>
                                        @include('schedule_list',array('value'=>$t_c_t))
                                    </select>
                                </div><br/><br/>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <select   class="form-control" name="f_o_t">
                                        <option value="" @if(empty($f_o_t)) {{"Selected"}} @endif label="Open Time"></option>
                                        @include('schedule_list',array('value'=>$f_o_t))
                                    </select>
                                </div>
                                <div class="col-md-4">
                                    <select  class="form-control"  name="f_c_t">
                                        <option value="" @if(empty($f_c_t)) {{"Selected"}} @endif label="Close Time"></option>
                                        @include('schedule_list',array('value'=>$f_c_t))
                                    </select>
                                </div><br/><br/>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <select   class="form-control" name="s_o_t">
                                        <option value="" @if(empty($s_o_t)) {{"Selected"}} @endif label="Open Time"></option>
                                        @include('schedule_list',array('value'=>$s_o_t))
                                    </select>
                                </div>
                                <div class="col-md-4">
                                    <select  class="form-control"  name="s_c_t">
                                        <option value="" @if(empty($s_c_t)) {{"Selected"}} @endif label="Close Time"></option>
                                        @include('schedule_list',array('value'=>$s_c_t))
                                    </select>
                                </div><br/><br/>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <select class="form-control" name="su_o_t">
                                        <option value="" @if(empty($su_o_t)) {{"Selected"}} @endif label="Open Time"></option>
                                        @include('schedule_list',array('value'=>$su_o_t))
                                    </select>
                                </div>
                                <div class="col-md-4">
                                    <select  class="form-control"  name="su_c_t">
                                        <option value="" @if(empty($su_c_t)) {{"Selected"}} @endif label="Close Time"></option>
                                        @include('schedule_list',array('value'=>$su_c_t))
                                    </select>
                                </div><br/><br/><br/>
                            </div>
                        </div>
    ...
    <div class="modal-dialog modal-lg fileDialogsize" >
        <div class="modal-content">
            <div class="modal-body" >
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <div class="controls">
                    <form class="form-group" method="post" action="{{url('/')}}/ajax/add_product" id="upload-product" enctype="multipart/form-data">
                        ...
                        <div class="col-md-8 col-lg-8"  >
                            ...
                            @include('user_categories_list',array('categories'=>$categories,'member_categories'=>$member_categories))
                            <a href="{{url('/')}}/edit_profile" style="float: right;font-size: 17px;color: #ca311b;
